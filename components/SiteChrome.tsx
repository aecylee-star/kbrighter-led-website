...
const navLinks = [
  ["Home", "/"],
  ["Products", "/products/2835-smd-led"],
...
const productLinks = [
  ["SMD LED", "/products/2835-smd-led"],
  ["DIP LED", "/products/2835-smd-led"],
  ["High Power LED", "/products/2835-smd-led"],
  ["Infrared LED", "/products/2835-smd-led"],
  ["LED Display Components", "/products/2835-smd-led"],
  ["PCBA Support", "/applications/led-for-pcb-pcba-projects"]
];
      ...
      <header className="site-header">
        <div className="site-wrap site-header-inner">
          ...
          <div className="site-actions">
            <Link className="site-btn site-btn-primary" href="/#contact">Get Quote <ArrowRight size={16} /></Link>
            <Link className="site-btn site-btn-dark" href="/#contact">Request Samples</Link>
          </div>
          ...
          <details className="site-mobile-menu">
            ...
            <div>
              ...
              <Link className="site-btn site-btn-primary" href="/#contact">Get Quote</Link>
              <Link className="site-btn site-btn-dark" href="/#contact">Request Samples</Link>
            </div>
          </details>
        </div>
      ...
      <div className="site-wrap site-footer-grid">
        <div className="site-footer-brand">
          ...
          <div className="site-footer-cta">
            <Link className="site-btn site-btn-primary" href="/#contact">Get Quote</Link>
            <a className="site-btn site-btn-outline" href="mailto:sales@kbrighter.com">Contact Sales</a>
          </div>
        </div>
        ...
        <FooterColumn
          ...
          links={[
            ["Download Center", "/download-center"],
            ["2835 Datasheet", "/products/2835-smd-led"],
