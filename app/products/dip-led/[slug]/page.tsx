      ...
      <section className="catalog-section catalog-white">
        <div className="catalog-wrap dip-two">
          ...
          <div className="dip-summary-card">
            ...
            <img
              className="dip-snapshot-image"
              src={product.image}
              alt={`${product.name} engineering product appearance on white background`}
              loading="lazy"
            />
            <dl>
