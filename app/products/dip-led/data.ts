...
export const dipProducts: DipLedProduct[] = [
  product({
    ...
    file: "1-8mm-teat-shape-dip-led.jpg",
  ...
  product({
    ...
    file: "2mm-tower-type-dip-led.jpg",
  ...
  product({
    ...
    file: "3mm-flat-head-dip-led.jpg",
  ...
  product({
    ...
    file: "3mm-round-head-dip-led.jpg",
  ...
  product({
    ...
    file: "3mm-round-dual-color-dip-led.jpg",
    packageSize: "3.0 x 5.3 mm",
  ...
  product({
    ...
    file: "5mm-straw-hat-dip-led.jpg",
  ...
  product({
    ...
    file: "5mm-straw-hat-rgb-dip-led.jpg",
    packageSize: "4.8 x 4.8 mm",
  ...
  product({
    ...
    file: "5mm-straw-hat-dual-color-dip-led.jpg",
    packageSize: "4.8 x 4.8 mm",
    viewingAngle: "60-120 degree",
    packaging: "1000PCS/bag",
    colors: "Red+Yellow, Red+Green, Red+Blue and Green+Blue",
  ...
  product({
    ...
    file: "5mm-flat-head-dip-led.jpg",
  ...
  product({
    ...
    file: "5mm-round-head-dip-led.jpg",
  ...
  product({
    ...
    file: "5mm-round-rgb-dip-led.jpg",
    packageSize: "5.0 x 8.7 mm",
    viewingAngle: "10-90 degree",
    packaging: "1000PCS/bag",
    colors: "R+Y+B, R+G+B and R+Y+G",
