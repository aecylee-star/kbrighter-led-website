    ...
    <main className="pd-page">
        ...
        <div className="pd-wrap pd-hero-grid">
          <div>
            ...
            <div className="pd-cta-row">
              <a className="pd-btn pd-btn-primary" href="#inquiry">Get Quote <ArrowRight size={18} /></a>
              <a className="pd-btn pd-btn-ghost" href="#inquiry">Request Samples</a>
              <a className="pd-btn pd-btn-ghost" href="#datasheet">Request Datasheet</a>
              <a className="pd-btn pd-btn-ghost" href="#inquiry">Contact Sales</a>
            </div>
          </div>
          <div className="pd-visual-panel">
            <span className="pd-badge">Engineering Review</span>
            <div className="pd-package">
              <div className="pd-led-top" />
              <div className="pd-led-base">
                <span />
                <span />
              </div>
            </div>
      ...
      <section className="pd-section">
        <div className="pd-wrap">
          ...
          <div className="pd-image-grid">
            <ImageBlock
              title="Product Image"
              text="Placeholder for the real SMD2835 LED product photo."
            />
            <ImageBlock
              title="Datasheet Preview"
              text="Placeholder for package dimensions, solder pad drawing and technical preview."
            />
            <ImageBlock
              title="Application Image"
              text="Placeholder for lighting, sign board backlight or PCBA application photo."
            />
          </div>
        </div>
      </section>
      ...
      <section id="datasheet" className="pd-section">
        <div className="pd-wrap pd-download">
          ...
          <a className="pd-btn pd-btn-primary" href="#inquiry"><Download size={18} /> Request Datasheet</a>
        </div>
      </section>
        ...
        <div className="pd-wrap">
          ...
          <div className="pd-related">
            {relatedProducts.map((item) => (
              <a href="#inquiry" key={item}>
                <PackageCheck size={24} />
                <strong>{item}</strong>
                <span>Ask for specifications</span>
              </a>
            ))}
          </div>
        </div>
      ...
      <section id="inquiry" className="pd-section">
        <div className="pd-wrap pd-inquiry">
          ...
          <form className="pd-form" action="mailto:sales@kbrighter.com" method="post" encType="text/plain">
            ...
            <button className="pd-btn pd-btn-primary" type="submit">Submit Inquiry <ArrowRight size={18} /></button>
          </form>
        </div>
      </section>
    </main>
...
function ImageBlock({ title, text }: { title: string; text: string }) {
  return (
